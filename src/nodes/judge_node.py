...
Use ONLY the information from the RAG context below when deciding applicable IPC sections.
...
Write a full and FINAL Indian court judgment using EXACT format:
